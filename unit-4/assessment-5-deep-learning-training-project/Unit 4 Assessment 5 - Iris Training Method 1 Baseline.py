...
This file demonstrates the first way to train a deep learning model for the
assessment. It uses the Iris dataset supplied through sklearn.datasets.load_iris.
